...
const Signup = (props) => {
  ...
  const handleSubmit = async (e) => {
    ...
    // json.success, 'success' is the variable used in backend 'Route : 2 Authenticate a user' api to know whether successful logged in or nt
    if (json.success) {
    ...
    <div className='container mt-2'>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          ...
          <input type="password" className="form-control" id="cpassword" name='cpassword' required minLength={5} />
        </div>
